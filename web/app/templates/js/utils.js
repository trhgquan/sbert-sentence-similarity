...
function generate_template(response_dict) {
  ...
  Object.entries(response_dict).map(([id, dict]) => {
    ...
    result_display +=
      "<h2 class='accordion-header' id='accordion_heading_" + id + "'>";
    result_display +=
      "<button class='accordion-button collapsed'" +
      " type='button' data-bs-toggle='collapse' data-bs-target='#accordion_collapse_" +
      id +
      "'" +
      " aria-expanded='false' aria-controls='accordion_heading_" +
      id +
      "'>";
    result_display += "<b>";
    ...
    result_display +=
      "<div id='accordion_collapse_" +
      id +
      "' class='accordion-collapse collapse'" +
      " aria-labeledby='accordion_heading_" +
      id +
      "' data-bs-parent='#accordion-template'>";
